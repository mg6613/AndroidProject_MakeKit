...
<%
    ...
    try {
        ...
        String WhereDefault = "select userinfo_like_userEmail from likeuser left outer join userinfo on userinfo_like_userEmail = userEmail where userinfo_userEmail = ?";
...
%>            
			{
                "userinfo_like_userEmail" : "<%=rs.getString(1) %>"
			}
