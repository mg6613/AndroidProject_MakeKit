...
public class EmailCheckActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_email_check);
                ...
                sendNum =findViewById(R.id.sendNum_emailCheck);
                msg = findViewById(R.id.tv_msg_emailCheck);

                findViewById(R.id.btnSubmit_emailCheck).setOnClickListener(mClickListener);
            ...
            View.OnClickListener mClickListener = new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    switch (v.getId()){
                        case R.id.btnSubmit_emailCheck:
            ...
            public void countDownTimer() {
                ...
                time_counter = findViewById(R.id.time_emailCheck);
