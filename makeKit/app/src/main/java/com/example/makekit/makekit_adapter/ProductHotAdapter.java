...
public class ProductHotAdapter extends RecyclerView.Adapter<ProductHotAdapter.ViewHolder> {
    ...
    public ProductHotAdapter(Context context, ArrayList<Product> items, String urlAddrBase) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LinearLayout v = (LinearLayout) LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.fragment_home_rec, viewGroup, false);//viewGroup는 각각의 아이템을 위해서 정의한 xml레이아웃의 최상위 레이아우싱다.
        ProductHotAdapter.ViewHolder vh = new ProductHotAdapter.ViewHolder(v);
