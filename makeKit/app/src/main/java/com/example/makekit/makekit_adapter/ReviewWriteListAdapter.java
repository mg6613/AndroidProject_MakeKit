...
// review 리스트
public class ReviewWriteListAdapter extends RecyclerView.Adapter<ReviewWriteListAdapter.MyViewHolder>{
    ...
    public ReviewWriteListAdapter(Context mContext, int layout, ArrayList<Review> data, String urlImage) {
